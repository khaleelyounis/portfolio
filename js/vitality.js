...
(function ($) {
  ...
  var portfolioInfo = {
    ...
    hearthstoneBattle: {
      ...
      description: `<p>Hearthstone Battle is based off of one of Blizzard’s top grossing games, Hearthstone. It is a single or multiplayer experience that challenges the user(s) to correctly match 9 pairs of cards with limited chances. You are given the choice of choosing your deck based on every class available in Hearthstone: Mage, Paladin, etc. In single player mode if you lose all of your healthpoints, you lose the match and can restart; however in multiplayer mode, you will be playing against each other with aims of taking down the opponent's lifepoints.</p><p> I am the sole developer on this application, and in future patches will be including a backend allowing for an even more immersive experience.</p>`,
